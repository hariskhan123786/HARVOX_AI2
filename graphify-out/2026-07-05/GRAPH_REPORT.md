...
## Corpus Check
- 165 files · ~241,257 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 929 nodes · 1898 edges · 50 communities (44 shown, 6 thin omitted)
...
Cohesion: 0.13
Nodes (12): AdminLayout(), GlassCard(), NeonButton(), PremiumLockOverlay(), languages, AutomationCenter(), ICON_MAP, PRESETS (+4 more)

### Community 6 - "Settings.jsx"
Cohesion: 0.12
Nodes (19): CATEGORIES, ModelSelector(), PROVIDER_BADGES, SPEED_COLORS, AI_PROVIDER_META, AI_PROVIDERS, ALL_MODELS, GEMINI_MODELS (+11 more)
...
Cohesion: 0.06
Nodes (48): PERSONALITIES, PROMPTS, chatAI(), getAIMetrics(), getAIOptions(), debugCode(), explainCode(), generateCode() (+40 more)
...
Cohesion: 0.11
Nodes (21): BrainMemorySettings(), taskSchema, createReminder(), createTask(), __dirname, DISTRACTING_APPS, enableFocusMode(), enableMeetingMode() (+13 more)
...
Cohesion: 0.15
Nodes (7): AdminRoute(), ProtectedRoute(), ROUTE_META, TopBar(), Login(), Register(), useAuthStore
...
### Community 23 - "cn"
Cohesion: 0.17
Nodes (15): registerModule(), deployRailway(), deployVercel(), __dirname, getEnvVars(), isCmdAvailable(), setEnvVar(), WORKSPACE_DIR (+7 more)
