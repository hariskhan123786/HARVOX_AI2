...
export default function About() {
  return (
    <div className="min-h-screen pt-24 px-4 pb-12 max-w-4xl mx-auto">
      <h1 className="text-5xl font-bold gradient-text mb-8 text-center">About HARVOX AI</h1>
      <div className="prose prose-invert prose-lg max-w-none space-y-6 text-muted">
        <p>
        ...
        <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Core Features</h2>
        ...
        <div className="mt-12 text-center">
          <Link to="/register">
            <NeonButton variant="primary" size="lg">Get Started Free</NeonButton>
          </Link>
        </div>
      </div>
    </div>
