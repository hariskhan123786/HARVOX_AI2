...
function updateAnimation(particle, data, changeDirection, destroyType, delta) {
  const minLoops = 0, minDelay = 0, identity2 = 1, minVelocity = 0, minDecay = 1;
...
function updateColorValue(data, decrease, delta) {
  ...
  const offset = data.offset ? randomInRangeValue(data.offset) : minOffset, velocity = (data.velocity ?? minVelocity) * delta.factor + offset * velocityFactor, decay = data.decay ?? identity2, max = data.max, min = data.min;
...
//# sourceMappingURL=chunk-2FJEDR7Q.js.map
