...
var AbsorberInstance = class {
  constructor(pluginManager, container, options, position) {
    ...
    __publicField(this, "_calcPosition", () => {
    ...
    __publicField(this, "_prepareToDie", () => {
      ...
      if ((this._lifeCount > minLifeCount || this._immortal) && duration !== void 0 && duration > minDuration) {
        this._duration = duration * millisecondsToSeconds;
      }
    });
    __publicField(this, "_updateParticlePosition", (particle, delta, v) => {
    ...
    if (this._duration !== void 0) {
      ...
      if (this._currentDuration >= this._duration) {
        ...
        if (this._lifeCount > minLifeCount || this._immortal) {
          ...
          this._spawnDelay = this._container.retina.reduceFactor ? getRangeValue(this.options.life.delay ?? defaultLifeDelay) * millisecondsToSeconds / this._container.retina.reduceFactor : Infinity;
        }
...
//# sourceMappingURL=AbsorberInstance-SA4EZFPN.js.map
